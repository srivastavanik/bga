...
<head>
    ...
    <link href="drugbank.css" type="text/css" rel="stylesheet" media="screen,projection" />
...
<body>
    ...
    <script>
        ...
        for (let i = 0; i < drugbank.length; i += 1000) {
            try {
                ...
                SmilesDrawer.parse(drugbank[i], function (tree) {
                    smilesDrawer.draw(tree, 'canvas' + i, 'oldschool', false);
                }, function (err) {
                    console.log(err);
                });
